    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white tracking-tight">CrowdGPT</h1>
          <p className="text-blue-400 text-sm mt-1 font-medium">
            Agentic Intelligence for Predictive Crowd Safety
          </p>
        </div>
        ...
        <p className="text-center text-xs text-gray-700 mt-6">
          CrowdGPT · Google Cloud · Agentic Premier League 2026
        </p>
      </div>
    </div>
  );
